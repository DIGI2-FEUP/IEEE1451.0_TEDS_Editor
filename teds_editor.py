...
class Ui_editorMainWindow(object):
    def setupUi(self, editorMainWindow):
        ...
        self.actionSave_bin_Checksummed = QtWidgets.QAction(editorMainWindow)
        self.actionSave_bin_Checksummed.setObjectName("actionSave_bin_Checksummed")
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionSave_bin)
        self.menuFile.addAction(self.actionLoad_bin)
        self.menuFile.addAction(self.actionSave_bin_Checksummed)
    ...
    def retranslateUi(self, editorMainWindow):
        ...
        self.actionSave_bin_Checksummed.setText(_translate("editorMainWindow", "Save .bin Checksummed"))
