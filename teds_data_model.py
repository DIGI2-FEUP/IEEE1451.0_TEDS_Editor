...
class TransducerChannel_TEDS_Data_Block():
    ...
    def __init__(self):
        ...
        self.CalKey = TEDS_Field(10,"CalKey","Calibration key",to_uint8,1)
        ...
        self.ChanType = TEDS_Field(11,"ChanType","TransducerChannel type key",to_uint8,1)
        ...
        self.LowLimit = TEDS_Field(13,"LowLimit","Design operational lower range limit",to_float32,4)
        self.LowLimit.set_value(0)
        self.fields.append(self.LowLimit)
        self.HiLimit = TEDS_Field(14,"HiLimit","Design operational upper range limit",to_float32,4)
        self.HiLimit.set_value(0)
        self.fields.append(self.HiLimit)
        self.OError = TEDS_Field(15,"OError","Worst-case uncertainty",to_float32,4)
        self.OError.set_value(0)
        self.fields.append(self.OError)
        self.SelfTest = TEDS_Field(16,"SelfTest","Self-test key",to_uint8,1)
        ...
        self.MRange = TEDS_Field(17,"MRange","Multi-range capability",to_uint8,1)
        self.MRange.set_value(0)
        self.fields.append(self.MRange)
        # Data converter-related information — —
        #18 Sample — —
        self.DatModel = TEDS_Field(40,"DatModel","Data model",to_uint8,1)
        ...
        self.ModLenth = TEDS_Field(41,"ModLenth","Data model length",to_uint8,1)
        self.ModLenth.set_value(0)
        self.fields.append(self.ModLenth)
        self.SigBits = TEDS_Field(42,"SigBits","Model significant bits",to_uint16,2)
        self.SigBits.set_value(0)
        self.fields.append(self.SigBits)
        #19 DataSet
        self.Repeats = TEDS_Field(43,"Repeats","Maximum data repetitions",to_uint16,2)
        self.Repeats.set_value(0)
        self.fields.append(self.Repeats)
        self.SOrigin = TEDS_Field(44,"SOrigin","Series origin",to_float32,4)
        self.SOrigin.set_value(0)
        self.fields.append(self.SOrigin)
        self.StepSize = TEDS_Field(45,"StepSize","Series increment",to_float32,4)
        ...
        self.PreTrigg = TEDS_Field(47,"PreTrigg","Maximum pre-trigger samples",to_uint16,2)
        self.PreTrigg.set_value(0)
        self.fields.append(self.PreTrigg)
        # Timing-related information
        self.UpdateT = TEDS_Field(20,"UpdateT","TransducerChannel update time (tu)",to_float32,4)
        self.UpdateT.set_value(0)
        self.fields.append(self.UpdateT)
        self.WSetupT = TEDS_Field(21,"WSetupT","TransducerChannel write setup time (tws)",to_float32,4)
        self.WSetupT.set_value(0)
        self.fields.append(self.WSetupT)
        self.RSetupT = TEDS_Field(22,"RSetupT","TransducerChannel read setup time (trs)",to_float32,4)
        self.RSetupT.set_value(0)
        self.fields.append(self.RSetupT)
        self.SPeriod = TEDS_Field(23,"SPeriod","TransducerChannel sampling period (tsp)",to_float32,4)
        self.SPeriod.set_value(0)
        self.fields.append(self.SPeriod)
        self.WarmUpT = TEDS_Field(24,"WarmUpT","TransducerChannel warm-up time",to_float32,4)
        self.WarmUpT.set_value(0)
        self.fields.append(self.WarmUpT)
        self.RDelayT = TEDS_Field(25,"RDelayT","TransducerChannel read delay time (tch)",to_float32,4)
        self.RDelayT.set_value(0)
        self.fields.append(self.RDelayT)
        self.TestTime = TEDS_Field(26,"TestTime","TransducerChannel self-test time requirement",to_float32,4)
        self.TestTime.set_value(0)
        self.fields.append(self.TestTime)
        # Time of the sample information
        self.TimeSrc = TEDS_Field(27,"TimeSrc","Source for the time of sample",to_uint8,1)
        ...
        self.InPropDl = TEDS_Field(28,"InPropDl","Incoming propagation delay through the data transport logic",to_float32,4)
        self.InPropDl.set_value(0)
        self.fields.append(self.InPropDl)
        self.OutPropD = TEDS_Field(29,"OutPropD","Outgoing propagation delay through the data transport logic",to_float32,4)
        self.OutPropD.set_value(0)
        self.fields.append(self.OutPropD)
        self.TSError = TEDS_Field(30,"TSError","Trigger-to-sample delay uncertainty",to_float32,4)
        self.TSError.set_value(0)
        self.fields.append(self.TSError)
        # Attributes
        #31 Sampling Sampling attribute — —
        self.SampMode = TEDS_Field(48,"SampMode","Sampling mode capability",to_uint8,1)
        ...
        self.SDefault = TEDS_Field(49,"SDefault","Default sampling mode",to_uint8,1)
        ...
        self.DataXmit = TEDS_Field(32,"DataXmit","Data transmission attribute",to_uint8,1)
        ...
        self.Buffered = TEDS_Field(33,"Buffered","Buffered attribute",to_uint8,1)
        ...
        self.EndOfSet = TEDS_Field(34,"EndOfSet","End-of-data-set operation attribute",to_uint8,1)
        ...
        self.EdgeRpt = TEDS_Field(35,"EdgeRpt","Edge-to-report attribute",to_uint8,1)
        ...
        self.ActHalt = TEDS_Field(36,"ActHalt","Actuator-halt attribute",to_uint8,1)
        ...
        # Sensitivity
        self.Directon = TEDS_Field(37,"Directon","Sensitivity direction",to_float32,4)
        ...
        self.DAngles = TEDS_Field(38,"DAngles","Direction angles Two",to_float32,8)
        self.DAngles.set_value(0)
        self.fields.append(self.DAngles)
        # Options
        self.ESOption = TEDS_Field(39,"ESOption","Event sensor options",to_uint8,1)
